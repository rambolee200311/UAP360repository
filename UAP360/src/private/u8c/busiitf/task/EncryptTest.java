...
public class EncryptTest implements nc.bs.pub.taskcenter.IBackgroundWorkPlugin {
	...
	public String executeTask(BgWorkingContext param) throws BusinessException {
		...
		strResult="[{'acCode':'866680369910001','applyAmount':0.0,'applyRmb':0.0,'bkName':'招商银行股份有限公司北京方庄支行','comCode':'A01','comName':'航联保险经纪有限公司','curRate':1.0,'currency':'CNY','dpName':'','insuranceCode':'01000428','insuranceName':'中国太平洋财产保险股份有限公司天津分公司','operatorCode':'B000367','pmName':'','smName':'','transferAmount':246364.53,'transferApplyDate':'2023-03-29','transferApplyNo':'ZFSQB0J820230329152602202303291632','transferBusinType':'F3-09','transferRMB':246364.53,'zyx1':'','zyx2':'','zyx3':'','zyx4':'','zyx5':'','arrivalRegiCode':'1001A310000000003TCN'}]";
