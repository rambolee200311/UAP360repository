...
public class ReverseInvoiceDetail {
	private int rowNo;//行号，1开始自增
	private String insurTypeCode;//险种编码
	private String insurTypeName;//险种名称
	private String supInsurTypeCode;//险种编码
	private String supInsurTypeName;//险种名称
	...
	public String getSupInsurTypeCode() {
		return supInsurTypeCode;
	}
	public void setSupInsurTypeCode(String supInsurTypeCode) {
		this.supInsurTypeCode = supInsurTypeCode;
	}
	public String getSupInsurTypeName() {
		return supInsurTypeName;
	}
	public void setSupInsurTypeName(String supInsurTypeName) {
		this.supInsurTypeName = supInsurTypeName;
	}
	public int getRowNo() {
		return rowNo;
	}
