...
public class ParentVO {
    ...
    private String lrr;
    private String lrr_code;
    private String lrr_name;
    private String djzt;
    private Double ybje;
    private Double bbje;
    ...
    private String zzzt;
    private String ywbm;
    private String ywbm_code;
    private String ywbm_name;
    private String xslxbm;
    private String xslxbm_code;
    private String xslxbm_name;
	...
	public String getDwbm_code() {
		return dwbm_code;
	}
	public void setDwbm_code(String dwbm_code) {
		this.dwbm_code = dwbm_code;
	}
	...
	public boolean isQcbz() {
		return qcbz;
	}
	public void setQcbz(boolean qcbz) {
		this.qcbz = qcbz;
	}
	...
	public String getLrr_code() {
		return lrr_code;
	}
	public void setLrr_code(String lrr_code) {
		this.lrr_code = lrr_code;
	}
	...
	public void setYbje(Double ybje) {
		this.ybje = ybje;
	}
	public Double getBbje() {
		return bbje;
	}
	public void setBbje(Double bbje) {
		this.bbje = bbje;
	}
	...
	public String getYwbm_code() {
		return ywbm_code;
	}
	public void setYwbm_code(String ywbm_code) {
		this.ywbm_code = ywbm_code;
	}
	public String getYwbm_name() {
		return ywbm_name;
	}
	public void setYwbm_name(String ywbm_name) {
		this.ywbm_name = ywbm_name;
	}
	public String getXslxbm() {
		return xslxbm;
	}
	public void setXslxbm(String xslxbm) {
		this.xslxbm = xslxbm;
	}
	public String getXslxbm_code() {
		return xslxbm_code;
	}
	public void setXslxbm_code(String xslxbm_code) {
		this.xslxbm_code = xslxbm_code;
	}
	public String getXslxbm_name() {
		return xslxbm_name;
	}
	public void setXslxbm_name(String xslxbm_name) {
		this.xslxbm_name = xslxbm_name;
	}
	...
	public String getPj_jsfs_code() {
		return pj_jsfs_code;
	}
	public void setPj_jsfs_code(String pj_jsfs_code) {
		this.pj_jsfs_code = pj_jsfs_code;
	}
	public String getPj_jsfs_name() {
		return pj_jsfs_name;
	}
