...
public class ArrivalQryRep {
	...
	public List<ArrivalQryRepDetail> detail;//到账对账接口明细
	...
	public List<ArrivalQryRepDetail> getDetail() {
		return detail;
	}
	public void setDetail(List<ArrivalQryRepDetail> detail) {
		this.detail = detail;
	}
